...
def test_timesheet_quick_add(browser: 'AppTestBrowser', regular_user, resource_factory, freeze_frontend_time):
    ...
    element = browser.driver.find_element(By.XPATH, '//div[@role="button" and starts-with(@id, "draggable-Wed Jun 25 2025")]')
    ...
    #  ADD ASSERT
    browser.assert_element(By.XPATH, '//div[starts-with(@id, "droppable-Wed Jun 25 2025")]//span[text()="4"]')
