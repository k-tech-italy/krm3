...
class TestTaskAPIListView:
    ...
    def test_returns_valid_time_entry_data(self, task_end_date, admin_user, api_client):
        ...
        assert response.json() == {
            ...
            'days': {
                '2024-01-01': {'hol': True, 'nwd': True, 'closed': False, 'mealVoucher': None},
                '2024-01-02': {'hol': False, 'nwd': False, 'closed': False, 'mealVoucher': None},
                '2024-01-03': {'hol': False, 'nwd': False, 'closed': True, 'mealVoucher': None},
                '2024-01-04': {'hol': False, 'nwd': False, 'closed': True, 'mealVoucher': None},
                '2024-01-05': {'hol': False, 'nwd': False, 'closed': False, 'mealVoucher': None},
                '2024-01-06': {'hol': True, 'nwd': True, 'closed': False, 'mealVoucher': None},
                '2024-01-07': {'hol': True, 'nwd': True, 'closed': False, 'mealVoucher': None},
            },
            'schedule': {
                '2024-01-01': 0,
                '2024-01-02': 2,
